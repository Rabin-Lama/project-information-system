...
<head>
  ...
  <title>PIS | <?php echo $title; ?></title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo base_url('dashboard'); ?>" class="logo">
      ...
      <span class="logo-mini">PIS</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Project</b> IS</span>
    </a>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  ...
                  <small>Member since <?php echo date('F, Y', strtotime($this->session->userdata('joined_date'))); ?></small>
                </p>
              </li>
              <!-- Menu Body -->
              <li class="user-body">
          ...
          <ul class="treeview-menu">
            <?php
              foreach($projects as $project) {
                ...
                $project_name = strlen($project_name) > 25 ? substr($project_name, 0, 25).'&hellip;' : $project_name;
                echo '<li><a href="'.base_url('project/load_project').'/'.$project->id.'"><i class="fa fa-circle-o"></i>' . $project_name . '</a></li>';
              }
            ?>
          </ul>
        </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <?php
          //$total_uri_segments = $this->uri->total_segments();
          for($i=1; $i<=$this->uri->total_segments(); $i++) {
            $string = str_replace('-', ' ', $this->uri->segment($i));
            $string = preg_replace('/[^A-Za-z0-9\-]/', ' ', $string);
            echo '<li><a href="#">' . ucfirst($string) . '</a></li>';
          }
        ?>        
